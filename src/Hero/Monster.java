...
public class Monster extends GameObjectDynamic {
	...
	public void move() {
        if (getDirect() == 1 ) { x+=MONSTER_SPEED ;loadImage("res/textures/img/tauvutru.png");}
        else if (getDirect() == -1 ) { x-=MONSTER_SPEED; loadImage("res/textures/img/tauvutru.png");}
        else if (getDirect() == 2 )  { y-=MONSTER_SPEED; loadImage("res/textures/img/tauvutru.png");}
        else if (getDirect() == -2 ) { y+=MONSTER_SPEED; loadImage("res/textures/img/tauvutru.png");}
        timez+=1; 
